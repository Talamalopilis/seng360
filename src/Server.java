...
public class Server
{
    ...
    public String checkInput() throws Exception {
		if (debug == true) System.out.println("checkInput() called from Server");
    ...
    public void sendOutput(String message) throws Exception {
		...
		if (securityArray[0] == 1 && confidentialityActivateFlag == 1){  //if encryption active
			...
			if (debug == true) System.out.println("Message sent to the client : " + new String(encryptedMessage));
		} else{
			if (debug == true) System.out.println("Not encrypting message");
			bw.write(message);
			if (debug == true) System.out.println("Message sent to the client : " + message);
		}
    ...
    public static void main(String[] args)
    {
        try {
            ...
            while(securityInitializationFlag == 0)
            {
                ...
                if (debug == true) System.out.println("Message received from client is : "+message);
				...
				if(clientRequestFlag == 1){
					if(securityStringServer.equals(message) && rejectionFlag == 0){
						...
						if (debug == true) System.out.println("Message sent to the client is : "+returnMessage);
					}
				}
			...
			if (debug == true) System.out.println("Now exiting the securityInitializationFlag loop");
